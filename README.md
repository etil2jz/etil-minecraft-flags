...
## Java distribution
GraalVM aims to provide high-performance runtime with new compiler optimizations. It is available for Java 11 & 17.
You can grab the Community Edition [here](https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-21.3.0), tho a part of the flags won't work without [the Enterprise Edition](https://www.oracle.com/downloads/graalvm-downloads.html?selected_tab=21).
...
- [x] Vanilla
- [x] Spigot/Paper and its multiple forks… ([Airplane](https://github.com/TECHNOVE/Airplane) is recommended)
- [x] Sponge
- [x] Fabric
- [x] Forge
